...
public class LocalKeyStoreService implements KeyManagementService {
  ...
  public PrivateKey getPrivateKey(String alias) {
    ...
    if (key == null) {
      throw new EdiSecurityException("PrivateKey alias not found in KeyStore cache: " + alias);
    }
    return key;
  }
  ...
  public X509Certificate getCertificate(String alias) {
    ...
    if (cert == null) {
      throw new EdiSecurityException("Certificate not found in KeyStore cache for alias: " + alias);
    }
    return cert;
  }
